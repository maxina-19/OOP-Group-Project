...
public abstract class Patient {
    ...
    public Patient(String name, int age, String contactInfo, String medicalHistory, String id) {
        this.name = name;
        this.age = age;
    ...
    public void scheduleAppointment(Appointment appointment) {
        ...
        System.out.println("Appointment scheduled for " + this.name + " on " + appointment.getApptDate()
                + " at " + appointment.getApptTime());
    }
